...
public class TreeNode<T, U> {
    ...
    /**
     * Get the path from the root to this node, as a list. List is ordered from root to this node.
     *
     * @return a path from the root to this node
     */
    public ArrayList<TreeNode<T, U>> pathFromRoot() {
        if (parent == null) {
            // No parent, add this node to a new list
            return new ArrayList<>(Arrays.asList(this));
        } else {
            // Add this node to the list generated by parent
            ArrayList<TreeNode<T, U>> parentList = parent.pathFromRoot();
            parentList.add(this);
            return parentList;
        }
    }
    ...
    /**
     * Get the list of states from the root to this node. List is ordered from root to this node
     *
     * @return a state path from the root to this node
     */
    public ArrayList<T> statePathFromRoot() {
        if (parent == null) {
            // No parent, add this node's state to a new list
            return new ArrayList<>(Arrays.asList(state));
        } else {
            // Add this node's state to the list generated by parent
            ArrayList<T> parentList = parent.statePathFromRoot();
    ...
    /**
     * Get the list of actions from the root to this node. List is ordered from root to this node
     *
     * @return an action path from the root to this node
     */
    public ArrayList<U> actionPathFromRoot() {
        if (parent == null) {
            // No parent, add this node's action to a new list. Make sure there is an action to add
            if (action != null) {
                return new ArrayList<>(Arrays.asList(action));
            } else {
                return new ArrayList<>();
            }
        } else {
            // Add this node's action to the list generated by parent
            ArrayList<U> parentList = parent.actionPathFromRoot();

            // Make sure there is an action to add
            if (action != null) {
                parentList.add(action);
            }
